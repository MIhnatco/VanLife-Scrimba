...
export default function Home() {
  return (
    <main
      className="min-h-[450px] text-white py-12 px-8 bg-[url('assets/images/home-hero.png')] bg-no-repeat bg-cover"
      role="main"
      aria-labelledby="page-title"
    >
      <h1 className="font-bold text-4xl my-8" id="page-title">
